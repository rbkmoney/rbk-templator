...
@Component
public class EntryStateToCaptureRequestConverter implements Converter<CustomEntryStateModel, CaptureRequest> {

    @Override
    public CaptureRequest convert(CustomEntryStateModel entryStateModel) {
